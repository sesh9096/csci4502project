...
this offensive stragey, we analyze whether longer passes resulting in more yards
...
their positions in the game. For example, a wide reciever may be directed to run
...
% TODO: The following paragraph revised and under methodology:
...
rare. Players playing quarterback (QB), wide reciever (WR), and tight end (TE)
...
before being tackled, we can see that in the range of approximately [-8,8], the
...
\subsubsection{Exploritory analysis}

% TODO: Add conclusion (Isaac & Sean)

\subsubsection{Grouping tackles}

% TODO: Add conclusion (Tim & Sean)
...
% TODO: Add conclusion (Sean)

\subsubsection{Choosing specific offensive formation types}

The dataset contains six offensive formation types, with Shotgun and and
...
\begin{itemize}
  \item Isaac Kou
  % TODO: add individual contributions
  \begin{itemize}
    \item Tackle success (classifiers): Naive Bayesian
    \item Tackle success (classifiers): Decision tree
    \item Tackles as a predictor of victory: Naive Bayesian
    \item All classifiers: SMOTE re-analysis
  \end{itemize}
  \item Sean Shi
  % TODO: add individual contributions
  \item Timur Tripp
